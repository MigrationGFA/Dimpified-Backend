...
const sendCourseCreationEmail = async ({
  organizationName,
  email,
  title,
  price,
              ...
              >
                <div>
                  ...
                  >
                    ...
                    <p style="margin-bottom: 2px; color: #333">
                      Your course is now live and available for learners to
...
`;
  ...
  return sendEmail({
    to: email,
    subject:
      "Congratulations! Your New Course is Now Live on Dimpified Platform",
...
module.exports = sendCourseCreationEmail;
